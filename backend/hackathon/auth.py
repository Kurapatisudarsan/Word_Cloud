...
def hash_otp_code(code: str, *, salt_b64: Optional[str] = None, iterations: int = 100000):
...
def dispatch_otp(*, channel: str, identifier: str, otp: Optional[str] = None, display_name: Optional[str] = None) -> None:
